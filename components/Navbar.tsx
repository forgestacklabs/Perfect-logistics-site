...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <motion.nav
        className="fixed w-full top-0 z-50 bg-[#dbeafe] shadow-md border-b border-blue-200"
        initial={{ y: -100 }}
        animate={{ y: 0 }}
            ...
            <div className="flex items-center justify-between h-16">
                    ...
                    >
                      <motion.span
                        className={`text-sm font-medium transition-colors duration-200 ${
                          activeLink === link.id ? 'text-blue-500' : 'text-gray-700'
                        }`}
              ...
              >
                <motion.button
                  ...
                  className="px-5 py-2 text-sm font-semibold rounded-lg bg-blue-500 text-white hover:bg-blue-600 transition-colors duration-200"
                  whileHover={{
                    scale: 1.05,
              ...
              <motion.button
                ...
                className="lg:hidden p-2 rounded-lg text-gray-700 hover:bg-gray-100 active:bg-gray-200"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
      ...
      {/* Mobile Sidebar Menu */}
      <motion.div
        className="lg:hidden fixed top-0 right-0 h-full w-80 max-w-[85vw] z-50 bg-white shadow-2xl"
        initial={{ x: '100%' }}
        animate={{
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center">
                ...
                <span className="text-lg font-bold text-black">erfect</span>
                <span className="mx-0.5 text-lg font-bold text-blue-500">L</span>
                <span className="text-lg font-bold text-black">ogistics</span>
              </div>
            </div>
            <motion.button
              suppressHydrationWarning
          ...
          <div className="p-6 border-t border-gray-200">
            <motion.button
              suppressHydrationWarning
              className="w-full px-6 py-3 text-sm font-semibold rounded-lg bg-blue-500 text-white hover:bg-blue-600 active:bg-blue-700 shadow-md transition-colors duration-200"
